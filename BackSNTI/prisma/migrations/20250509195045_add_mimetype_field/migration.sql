-- CreateEnum
CREATE TYPE "rol_usuario" AS ENUM ('Administrador', 'Recursos Humanos', 'Empleado');
...
-- CreateIndex
CREATE UNIQUE INDEX "usuarios_id_trabajador_key" ON "usuarios"("id_trabajador");
...
-- AddForeignKey
ALTER TABLE "trabajadores" ADD CONSTRAINT "trabajadores_id_seccion_fkey" FOREIGN KEY ("id_seccion") REFERENCES "secciones"("id_seccion") ON DELETE NO ACTION ON UPDATE NO ACTION;
